...
class memberApi extends baseApi {
    ...
    public function applyFriend() {
        ...
        if($res || 1){
            $note = '<a href="home.php?mod=space&uid=1">'.$me['username'].'</a> 请求加您为好友&nbsp;&nbsp;<a onclick="showWindow(this.id, this.href, \'get\', 0);" class="xw1" id="afr_1" href="home.php?mod=spacecp&ac=friend&op=add&uid='.$who.'&from=notice">批准申请</a>';
